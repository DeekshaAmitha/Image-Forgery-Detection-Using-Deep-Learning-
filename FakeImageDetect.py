...
main = tkinter.Tk()
main.title("Image Forgery Detection Using Deep Learning") #designing main screen
...
def classify():
    ...
    msg = ""
    if predict == 0:
        msg = "Image Contains real face Image"
    if predict == 1:
        msg = "Image Contains forged face Image"
...
font = ('times', 16, 'bold')
title = Label(main, text='Image Forgery Detection Using Deep Learning', justify=LEFT)
title.config(bg='lavender', fg='DarkOrchid1')  
